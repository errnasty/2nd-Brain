...
const NAV: NavCommand[] = [
  ...
  { label: "ThinkTank", href: "/thinktank", icon: <Lightbulb className="h-4 w-4" />, keywords: "learn topics deck idea cards deepstash" },
 ...
 *
 * Mounted lazily by `command-palette.tsx`; `initialOpen` is set when the mount
 * itself was the open signal (the trigger fired before this chunk existed).
 */
export function CommandPaletteImpl({ initialOpen = false }: { initialOpen?: boolean }) {
