 ...
 *
 * Mounted lazily by `quick-capture.tsx`; `initialOpen` is set when the mount
 * itself was the open signal (the event fired before this chunk existed).
 */
export function QuickCaptureImpl({ initialOpen = false }: { initialOpen?: boolean }) {
